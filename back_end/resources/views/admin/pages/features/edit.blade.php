                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="project">
                                            ...
                                            @foreach ($projects as $project)
                                                <option {{ $feature->project_id == $project->id ? ' selected' : '' }} value="{{ $project->id }}">{{ $project->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="duration">
                                            ...
                                            <option {{ $feature->deadline == '0' ? 'selected' : '' }} value="0">None</option>
                                            <option {{ $feature->deadline == '1' ? 'selected' : '' }} value="1">1 day</option>
                                            <option {{ $feature->deadline == '3' ? 'selected' : '' }} value="3">3 days</option>
                                            <option {{ $feature->deadline == '5' ? 'selected' : '' }} value="5">5 days</option>
                                            <option {{ $feature->deadline == '7' ? 'selected' : '' }} value="7">1 week</option>
                                            <option {{ $feature->deadline == '14' ? 'selected' : '' }} value="14">2 weeks</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
