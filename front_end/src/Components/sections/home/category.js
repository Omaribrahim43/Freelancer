              ...
              <div className="wt-categoryexpl">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-08.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-02.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-03.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-04.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-05.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-06.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
                ...
                <div className="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
                  <div className="wt-categorycontent">
                    <figure>
                      <img
                        src="images/categories/img-07.png"
                        alt="image description"
                      />
                    </figure>
                    <div className="wt-cattitle">
